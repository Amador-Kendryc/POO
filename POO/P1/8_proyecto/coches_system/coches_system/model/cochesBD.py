...
class Camiones:
    ...
    @staticmethod
    def inupdate(id,marca,color,modelo,velocidad,caballaje,plazas,eje,capacidadCarga):
        try:
            cursor.execute(
...
class Camionetas:
    ...
    @staticmethod
    def update(id,marca,color,modelo,velocidad,caballaje,plazas,traccion,cerrada):
        try:
            cursor.execute(
